	...
	<section id="trakt-tv">
		...
		<div class="content">
			<div class="trakt-options<%= App.Trakt.authenticated ? " authenticated" : "" %>">
				...
				<% } else { %>
					<span>
						<%= i18n.__("Enter your Trakt.tv details here to automatically 'scrobble' episodes you watch in Guimovie") %>
					</span>
					<span>
					...
					<span>
						<em><%= i18n.__("Guimovie stores an encrypted hash of your password in your local database") %></em>
					</span>
				<% } %>
			</div>
		</div>
