(function(App) {
    ...
    var Help = Backbone.Marionette.ItemView.extend({
        ...
        initialize: function() {
            dyks = [
                i18n.__('You can paste magnet links anywhere in Guimovie with CTRL+V.'),
                i18n.__('You can drag & drop a .torrent file into Guimovie.'),
                i18n.__('The Guimovie project started in February 2014 and has already had 150 people that contributed more than 3000 times to it\'s development in August 2014.'),
                i18n.__('If a subtitle for a TV series is missing, you can add it on <a class="link" href="http://opensubtitles.org">opensubtitles.org</a>. And the same way for a movie, but on <a class="link" href="http://yifysubtitles.com">yifysubtitles.com</a>.'),
