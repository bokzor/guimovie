(function(App) {
    ...
    App.View.MovieDetail = Backbone.Marionette.ItemView.extend({
        ...
        events: {
            ...
            'click .activateTooltip': 'changeQuality',
        },
        ...
        onShow: function() {
            ...
            this.$el.css({
                transformOrigin: App.origin.x + 'px ' + App.origin.y + 'px'
            }).transition({
                scale: 1,
                opacity: 1,
            }, 300, 'cubic-bezier(0.55, 0, 0.1, 1)');
            ...
            $('.activateTooltip, .star-container,.movie-imdb-link,.q720,input,.magnet-link').tooltip({
                html: true
            });
        ...
        renderHealth: function() {
            ...
            var ratio = torrent.peers > 0 ? torrent.seeds / torrent.peers : +torrent.seeds;
            ...
            $('.health-icon').tooltip({
                ...
                .addClass(health)
                .attr('data-original-title', i18n.__('Health ' + health) + ' - ' + i18n.__('Ratio:') + ' ' + ratio.toFixed(2) + ' <br> ' + i18n.__('Seeds:') + ' ' + torrent.seeds + ' - ' + i18n.__('Peers:') + ' ' + torrent.peers)
                .tooltip('fixTitle');
        },
