<div class="help-container">
	...
	<div class="content">
		...
		<div class="help-outer">
			<h2 class="top"><%= i18n.__("What does Guimovie offer?") %></h2>
			<p><%= i18n.__("With Guimovie, you can watch Movies and TV Series really easily. All you have to do is click on one of the covers, then click 'Watch Now'. But your experience is highly customizable:") %>
				<ul>
					<li><b><%= i18n.__("Movies") %>:</b> <%= i18n.__("Our Movies collection only contains High-Definition movies, available in 720p and 1080p. To watch a movie, simply open Guimovie and navigate through the movies collection, reachable through the 'Movies' tab, in the navigation bar. The default view will show you all movies sorted by popularity, but you can apply your own filters, thanks to the 'Genre' and 'Sort by' filters. Once you have chosen a movie you want to watch, click its cover. Then click 'Watch Now'. Don't forget the popcorn!") %></li>
					...
					<li><b><%= i18n.__("Custom Torrents and Magnet Links") %>:</b> <%= i18n.__("You can use custom torrents and magnets links in Guimovie. Simply drag and drop .torrent files into the application's window, and/or paste any magnet link.") %></li>
			...
			<h2><%= i18n.__("How does Guimovie work?") %></h2>
			<p><%= i18n.__("Guimovie streams video content through torrents. Our movies are provided by YTS (http://yts.re) and our TV Series by EZTV (http://eztv.it), while getting all metadata from Trakt (http://trakt.tv). We don't host any content ourselves.") %><br>
			...
			<%= i18n.__("Once the movie is fully downloaded, you continue to send parts to the other users. And everything is deleted from your computer when you close Guimovie. As simple as that.") %><br><br>
			<%= i18n.__("The application itself is built with Node-Webkit, HTML, CSS and Javascript. It works like the Google Chrome browser, except that you host the biggest part of the code on your computer. Yes, Guimovie works on the same technology as a regular website, like... let's say Wikipedia, or Youtube!") %>
			</p>
			...
			<p>Here are the few simple steps to take:
				...
				* Guimovie Version: stable 0.3.3<br>
