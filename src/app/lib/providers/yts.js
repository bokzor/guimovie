(function(App) {
    ...
    var queryTorrents = function(filters) {
        ...
        var url = 'http://localhost:8092/movie/?' + querystring.stringify(params).replace(/%E2%80%99/g, '%27');
    ...
    var queryTorrent = function(torrent_id, old_data) {
        return Q.Promise(function(resolve, reject) {
            ...
            var url = 'http://localhost:8092/movie/detail?' + querystring.stringify(params).replace(/%E2%80%99/g, '%27');
